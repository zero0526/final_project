...
class BaseConfig(BaseSettings):
    ...
    transmission_rate: Dict[str, float] = Field(default={"min": 1250, "max": 3750})
    ...
    task_max_batch: int= Field(default=60)
    task_min_batch: int= Field(default=60)
    ...
    max_queue_size: int = Field(default=200)
    ...
    norm_gflop: float= Field(default=100.0)
